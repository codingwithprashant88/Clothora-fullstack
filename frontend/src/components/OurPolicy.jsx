...
function OurPolicy() {
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-12 sm:gap-2 text-center py-10 text-xs sm:text-sm md:text-base text-gray-600 '>
        <div>
        ...
        <div>
            <img src={assets.verify} className='w-12 m-auto mb-5 ' alt="" />
