...
function Collection() {
  ...
  const sortProduct = () => {
    let copyPrice = filterProducts.slice();
    switch (sortType) {
      case "low-high":
        setFilterProducts(copyPrice.sort((a, b) => a.price - b.price));
        break;

      case "high-low":
        setFilterProducts(copyPrice.sort((a, b) => b.price - a.price));
        break;
    ...
    <div className="flex flex-col sm:flex-row gap-1 pt-10 border-t">
      ...
      <div className="min-w-60">
        <p
          ...
          className="my-0 text-xl flex items-center cursor-pointer gap-2 ml-10"
        >
          FILTER
          <img
      ...
      <div className="flex-1 ">
        <div className="flex justify-between text-base sm:text-2xl ml-8 mb-4">
